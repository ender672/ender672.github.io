...
[![Python sync strategy benchmark: wall time, CPU time, and peak memory vs row count](/assets/images/bench_strategies_chart.png)](/assets/images/bench_strategies_chart.png)
